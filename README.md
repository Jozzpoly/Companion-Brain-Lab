...
- Qualified Field Lab runtime `01bc4d1f2239c0c7608662e8881147e878a3862a` is **MACHINE-QUALIFIED ADVANCED FIELD LAB + TEMPORAL TRIAL EVIDENCE · NOT OWNER-READY · AUTONOMY NOT PROMOTED**. Persistent setup A/B now feeds bounded temporal A/B traces so authored dynamics can be compared by real trajectory/error/contact/blocking consequences, not only static configuration diffs.
