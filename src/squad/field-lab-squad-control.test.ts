...
describe("FieldLabSquadControl", () => {
  ...
  it("restores a complete authored control snapshot after unrelated perturbations", () => {
    const control = new FieldLabSquadControl();
  ...
  it("fails closed when a captured snapshot would violate roster or selection invariants", () => {
    const control = new FieldLabSquadControl();
    const captured = control.snapshot();
